...
function drawModel(x0 , y0 , size , dropdown , slider1 , slider2 , slider3  , slideri1 , slideri2 , slideri3 , sliderb , isBlink ) {
  ...
  // draw bias
  spottyRect(sliderb.slider.value() ,xb , yb , wb , hb ,"#64A6DE" ,"#2E2C51");
  textAlign(CENTER);
  textSize(20);
  fill("#2E2C51");
  strokeWeight(1);
  ...
  if (isBlink){
    spottyCircle(dropdown.output , xo , yo , ro , "#4E878C00" , "#2E2C51");
  }
  else {
