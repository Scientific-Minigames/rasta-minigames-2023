...
function setup() {
  ...
  map1.addNode(new GameObject(0.42566943674976915, 0.20342612419700215));
  map1.addNode(new GameObject(0.6398891966759003, 0.4004282655246253));
  map1.addNode(new GameObject(0.4025854108956602, 0.5781584582441114));
  map1.addNode(new GameObject(0.6786703601108033, 0.6477516059957173));
  map1.addEdge([0, 1]);
  map1.addEdge([0, 2]);
  map1.addEdge([0, 3]);
  map1.addEdge([1, 2]);
  ...
  map2.addNode(new GameObject(0.42566943674976915, 0.20342612419700215));
  map2.addNode(new GameObject(0.6398891966759003, 0.4004282655246253));
  map2.addNode(new GameObject(0.4025854108956602, 0.5781584582441114));
  map2.addNode(new GameObject(0.6786703601108033, 0.6477516059957173));
  map2.addEdge([0, 2]);
  map2.addEdge([2, 3]);
  maps.push(map2);

  let map2_1 = new MapGraph(map2Img, 6, 1);
  map2_1.addNode(new GameObject(0.42566943674976915, 0.20342612419700215));
  map2_1.addNode(new GameObject(0.6398891966759003, 0.4004282655246253));
  map2_1.addNode(new GameObject(0.4025854108956602, 0.5781584582441114));
  map2_1.addNode(new GameObject(0.6786703601108033, 0.6477516059957173));
  map2_1.addEdge([0, 2]);
  map2_1.addEdge([2, 3]);
  maps.push(map2_1);

  let map3 = new MapGraph(map3Img, 3, 1);
  map3.addNode(new GameObject(0.42566943674976915, 0.20342612419700215));
  map3.addNode(new GameObject(0.6398891966759003, 0.4004282655246253));
  map3.addNode(new GameObject(0.4025854108956602, 0.5781584582441114));
  map3.addNode(new GameObject(0.6786703601108033, 0.6477516059957173));
  map3.addNode(new GameObject(0.3717816683831102, 0.3340471092077088));
  map3.addEdge([2, 3]);
  map3.addEdge([0, 4]);
  map3.addEdge([4, 1]);
  map3.addEdge([4, 2]);
  ...
  map4.addNode(new GameObject(0.42566943674976915, 0.20342612419700215));
  map4.addNode(new GameObject(0.6398891966759003, 0.4004282655246253));
  map4.addNode(new GameObject(0.4025854108956602, 0.5781584582441114));
  map4.addNode(new GameObject(0.6786703601108033, 0.6477516059957173));
  map4.addNode(new GameObject(0.3717816683831102, 0.3340471092077088));
  map4.addNode(new GameObject(0.529351184346035, 0.6691648822269807));
  map4.addEdge([0, 4]);
  map4.addEdge([4, 1]);
  map4.addEdge([4, 2]);
  map4.addEdge([3, 5]);
  ...
  map4_1.addNode(new GameObject(0.42566943674976915, 0.20342612419700215));
  map4_1.addNode(new GameObject(0.6398891966759003, 0.4004282655246253));
  map4_1.addNode(new GameObject(0.4025854108956602, 0.5781584582441114));
  map4_1.addNode(new GameObject(0.6786703601108033, 0.6477516059957173));
  map4_1.addNode(new GameObject(0.3717816683831102, 0.3340471092077088));
  map4_1.addNode(new GameObject(0.529351184346035, 0.6691648822269807));
  map4_1.addEdge([0, 4]);
  map4_1.addEdge([4, 1]);
  map4_1.addEdge([4, 2]);
  map4_1.addEdge([3, 5]);
